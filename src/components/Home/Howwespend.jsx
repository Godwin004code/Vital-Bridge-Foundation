...
const Howwespend = () => {
  ...
  return (
    ...
    <div>
      ...
      <section >
        <div className='flex gap-2 mb-2'>
          <div className='w-[16px] h-[16px] my-auto bg-[#F59F24] rounded-[4px]'></div>
