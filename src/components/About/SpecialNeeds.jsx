...
const SpecialNeeds = () => {
        ...
        return (
                <div className='bg-[#f59f240d] py-20'>
                        ...
                        <div className='flex w-[90%] sm:flex-col justify-between mx-auto'>
                                <section className='flex flex-col sm:w-full w-[30%]'>
                                        <div className='flex mt-14 w-full cursor-pointer bg-[#FCEDC6] hover:bg-[#f2da9b] p-10' onClick={() => setCurrent("Education")}>
...
<path d="M13.8822 12.2415C14.0516 12.3043 14.2177 12.1507 14.1616 11.9874C13.7763 10.8662 12.3814 10.4479 11.0848 11.4427C10.4027 11.966 10.1464 12.0772 10.1399 12.08C10.5896 12.5046 11.1033 13.9294 12.2244 14.087C13.4593 14.2984 14.5523 13.1509 13.6581 12.6258C13.07 12.2805 12.3776 12.0799 11.6353 12.0799C12.4134 11.9143 13.1902 11.9853 13.8822 12.2415Z" fill="#FFEBB9"/>
<path d="M19.4744 11.4426C17.2361 9.72543 15.8086 12.4334 16.6959 12.1649C17.3261 11.9743 18.0151 11.9328 18.7061 12.0799C17.5352 12.0799 16.4559 12.5867 15.7363 13.4116C15.7954 12.1152 15.8848 11.3038 15.9884 10.7002C16.5865 10.6808 17.3837 10.2246 17.8215 9.42644C18.5762 8.15082 18.2262 6.84289 18.1136 6.01758C17.5238 6.55993 14.9478 5.92444 13.9266 7.57717C13.4754 8.30725 13.6066 9.19567 14.0811 9.8458C14.2313 10.0516 14.5905 9.95286 14.6008 9.70309C14.6453 8.61656 15.2179 7.79566 16.2853 7.34098C15.8063 7.9271 15.4918 8.58331 15.3294 9.26154C15.0768 10.3181 14.8131 11.0111 14.7162 14.3786C14.7064 14.7201 14.9993 15.0028 15.361 14.9985C15.6229 14.9954 15.8472 14.8385 15.9479 14.6102C16.101 14.263 16.3503 13.9036 16.756 13.5743C17.1414 13.9767 17.728 14.1909 18.335 14.0869C19.4513 13.93 19.9723 12.5021 20.4194 12.0798C20.4128 12.0771 20.1565 11.9659 19.4744 11.4426Z" fill="#FFEBB9"/>
<path d="M22.7649 15.6384C22.0651 15.19 21.3035 15.5096 20.9538 15.7003L16.5647 18.7342L13.9947 18.7347L13.3523 18.128H15.7124C16.4222 18.128 17.2172 17.6913 17.2172 16.9141C17.2172 16.089 16.4222 15.7003 15.7124 15.7003H14.828C14.1709 15.7003 13.4031 15.7556 12.8618 15.4819C12.3474 15.2347 11.7551 15.0941 11.1229 15.0941C10.0612 15.0941 9.11104 15.4938 8.45992 16.1242L5 19.341L8.85489 22.9817L10.1399 21.1614H16.2119C16.8595 21.1614 17.4846 20.937 17.9687 20.5308L22.8088 16.4701C23.0779 16.2444 23.0627 15.8293 22.7649 15.6384Z" fill="#FFEBB9"/>
</svg>
...
<path d="M17.7931 17.7293C15.5 17.7293 13.6344 15.8637 13.6344 13.5705C13.6344 12.6791 13.9121 11.8297 14.4376 11.1133L16.0579 8.70794L13.56 5L8.35563 12.7257C7.53737 13.8392 7.10498 15.1595 7.10498 16.5449C7.10498 20.1043 10.0007 23 13.56 23C16.9325 23 19.7088 20.4002 19.991 17.0994C19.3529 17.4984 18.5996 17.7293 17.7931 17.7293Z" fill="#FFEBB9"/>
                                        ...
                                        <div className='flex mt-14 hover:bg-[#f2da9b] bg-[#FCEDC6] p-10 w-full cursor-pointer' onClick={() => setCurrent("Environment")}>
