        ...
        <div className='bg-[#FCEDC6]'>
            <section className='w-[90%] flex sm:flex-col py-20 mx-auto'>
                ...
                <div className='sm:mt-10'>
                    ...
                    <ul className='flex justify-between w-full gap-4 mb-0 mt-10 items-center '>
                        <li className='flex gap-6 mb-5'> <Link className='my-auto' to="">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="15" cy="15" r="15" fill="#1D2130" />
                                <path d="M16.4573 13.794L22.1532 7.125H20.8032L15.8588 12.9154L11.9078 7.125H7.35156L13.3253 15.882L7.35156 22.875H8.70156L13.9238 16.7595L18.0964 22.875H22.6527L16.4573 13.794ZM14.6089 15.9585L14.0037 15.0866L9.18756 8.14875H11.2609L15.1467 13.7479L15.7519 14.6198L20.8043 21.8985H18.7309L14.6089 15.9585Z" fill="#FCEDC6" />
                            </svg>
                        </Link>
                        </li>
                        <li className='flex gap-6 mb-5'>
                            ...
                            <Link className='my-auto' to="">
                                <svg className='my-auto' width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M27.5 15C27.5 8.1 21.9 2.5 15 2.5C8.1 2.5 2.5 8.1 2.5 15C2.5 21.05 6.8 26.0875 12.5 27.25V18.75H10V15H12.5V11.875C12.5 9.4625 14.4625 7.5 16.875 7.5H20V11.25H17.5C16.8125 11.25 16.25 11.8125 16.25 12.5V15H20V18.75H16.25V27.4375C22.5625 26.8125 27.5 21.4875 27.5 15Z" fill="#1D2130" />
                                </svg>
                            </Link>
                        </li>
                        <li className='flex gap-6 mb-5'>
